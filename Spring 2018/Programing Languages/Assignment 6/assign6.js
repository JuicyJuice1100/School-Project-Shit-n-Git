...
var LENGTHHELPER = "^f x y.(((" + IF + " (" + ISEMPTY + " x)) y) ((f (" + TL + " x)) (" + SUCC + " y)))";
var Y_LENGTHHELPER = "(" + Y + " " + LENGTHHELPER + ")";

var LENGTH = "^f x.((" + Y_LENGTHHELPER + " x) " + ZERO + ")";
...
var SUMHELPER = "^f x y.(((" + IF + " (" + ISEMPTY + " x)) y) ((f (" + TL + " x)) ((" + ADD + " (" + HD + " x)) y)))";
var Y_SUMHELPER = "(" + Y + " " + SUMHELPER + ")";

var SUM = "^f x.((" + Y_SUMHELPER + " x) " + ZERO + ")";
