...
/*********************** LetsExp *******************************/
// function createLetsExp(v1, v2, fn, block){
//     return ["LetsExp", v1, v2, fn, block]
// }
// function isLetsExp(e){
//     return e[0] === "LetsExp"
// }
// function getLetsExpVar1(e){
//     if(isLetsExp(e))
//         return e[1]
//     else   
//         throw new Error("Interpreter error: The argument of getLetsExp is not a LetsExp")
// }
// function getLetsExpVar2(e){
//     if(isLetsExp(e))
//         return e[2]
//     else
//         throw new Error("Interpreter error: The argument of getLetsExp is not a LetsExp")
// }
// function getLetsExpFn(e){
//     if(isLetsExp(e))
//         return e[3]
//     else
//         throw new Error("Interpreter error: The argument of getLetsExp is not a LetsExp")
// }
// function getLetsExpBlcok(e){
//     if(isLetsExp(e))
//     return e[4]
// else
//     throw new Error("Interpreter error: The argument of getLetsExp is not a LetsExp")
...
exports.getLetsExpVar1 = getLetsExpVar1;
exports.getLetsExpVar2 = getLetsExpVar2;
exports.getLetsExpFn = getLetsExpFn;
