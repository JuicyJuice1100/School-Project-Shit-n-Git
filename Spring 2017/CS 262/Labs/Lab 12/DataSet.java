...
public class DataSet<E> implements Serializable, Cloneable
{
    private E[] dataSet;
    private int count;
    ...
    public void writeDataToFile(String fileName){
        ...
        object.writeObject(dataSet);

        object.close();
    }

    public void readDataFromFile(String fileName){
        FileInputStream file = new FileInputStream("~\\" + fileName + ".tmp");
    ...
    public boolean storeDSetObjectToFile(String fileName){

    }

    public DataSet<E> loadDSetObjectFromFile(String fileName){
    ...
    public Object clone(){
        try{
            ...
            System.out.println("Cloning now allowed.");
            return this;
        }
    }
